...
export const Sidebar: React.FC = () => {
  return (
    <div className="h-full flex flex-col justify-between p-8 bg-dark-800 text-white border-r border-gray-600 roboto">
      <div>
        <h1 className="text-2xl roboto text-blue-100">Project LocalDown</h1>
